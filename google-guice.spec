...
BuildRequires:  %{?scl_prefix}atinject-tck
...
Provides:       %{?scl_prefix}%{short_name} = %{version}-%{release}
...
Provides:       %{?scl_prefix}%{short_name}-javadoc = %{version}-%{release}
...
* Wed Jun 21 2017 Java Maintainers <java-maint@redhat.com> - 4.1-5.1
